...
int main(){ 
	...
	//
	StrapItems sItem1(100, "stitched", "emerald", "Null", "aso", 10, "16-19", 850, "");
	sCRUD.addItem(sItem1);

	sCRUD.viewItem(1);

	StrapItems sItem2(100, "stitched", "purple", "Null", "posa", 10, "16-19", 850, "");
	sCRUD.addItem(sItem2);
