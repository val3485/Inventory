...
public:
	...
	struct BattItems
	{
		...
		double price;
				...
				BattItems(int i, string ct, string b, int q, int rp, double p) //this is called a constructor, it reads(?) the data from the array in order.
			...
			vector<BattItems> allbatt_arr = {
				...
				{6, "maxell", "Maxell SR621SW", 30, 5, 450},
				{7, "maxell", "Maxell SR626SW", 30, 5, 450},
				{8, "maxell", "Maxell SR626SW", 30, 5, 450},
				...
				{33, "renata", "Renata 364", 20, 5, 550},
				{34, "renata", "Renata 371", 10, 5, 550},
				{35, "renata", "Renata 377", 20, 5, 550},
		...
		void Inventory_level(vector<BattItems> arr){
...
public:
	...
	void displayItems()
	{
		batt.DisplayMaxell(allbatt_arr, "MAXELL BATTERY");
