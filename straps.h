...
class Straps{
	private:
		...
		vector<StrapItems> allstraps_arr = { //vector is used make the array more efficient. you can modify it without manually entering the size 
			{1, "stitched", "black w/ black", "Null", "Buffalo Calf", 10, "16-19", 850, ""},
			{2, "stitched", "brown dark", "Null", "Buffalo Calf", 10, "16-19", 850, ""},
			{3, "stitched", "black w/ white", "Null", "Buffalo Calf", 10, "16-19", 850, ""},
			{4, "stitched", "brown light", "Null", "Buffalo Calf", 10, "16-19", 850, ""}, 

			{5, "no stitch", "black", "Alpha", "Null", 10, "16-24", 1500, ""},
			{6, "no stitch", "black", "Alpha", "Null", 10, "16-24", 1500, ""},
			{7, "no stitch", "black", "Alpha", "Null", 10, "16-24", 1500, ""},
			{8, "no stitch", "black", "Alpha", "Null", 10, "16-24", 1500, ""},
			...
			{17, "casio w/ cover", "black", "Casio", "Null", 10, "small", 1200, "1 hole"},
			{18, "casio w/ cover", "blue dark", "Casio", "Null", 10, "small", 1200, "1 hole"},
			{19, "casio w/ cover", "blue light", "Casio", "Null", 10, "small", 1200, "1 hole"},
			{20, "casio w/ cover", "pink dark", "Casio", "Null", 10, "small", 1200, "1 hole"},

			{21, "casio w/ cover", "black", "Casio", "Null", 10, "large", 1500, "2 hole"},
			{22, "casio w/ cover", "blue dark", "Casio", "Null", 10, "large", 1500, "2 hole"},
			{23, "casio w/ cover", "blue light", "Casio", "Null", 10, "large", 1500, "2 hole"},
			{24, "casio w/ cover", "pink dark", "Casio", "Null", 10, "large", 1500, "2 hole"}
		};
